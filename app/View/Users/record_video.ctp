...
<?php //echo $this->webroot."@@".WWW_ROOT."###".FULL_BASE_URL; die; ?>
    ...
    <article>         
        ...
        <script>
            ...
            function uploadToServer(recordRTC, callback) {
                ...
                makeXMLHttpRequest('save_video', formData, function(progress) {
                    if (progress !== 'upload-ended') {
                        callback(progress);
                        return;
                    }

                   // var initialURL = location.href.replace(location.href.split('/').pop(), '') + '/var/www/html/app/webroot/img/videos/';
					var initialURL = '<?php echo WWW_ROOT ?>/img/videos/';
	...
	<source src="<?php echo FULL_BASE_URL; ?>/img/videos/7328180538520456.webm" type="video/webm">
	</video> 
	</section>
</article>
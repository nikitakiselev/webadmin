...
$siteDescription = '30 Second Pitch Video';
?>
<!DOCTYPE html>
<html>
<head>
...
<body style="background: rgba(0, 0, 0, 0) linear-gradient(128deg, #cddddd, #cddddd) repeat fixed 0 0;" class="public">
    <div id="container">
        <div id="header" >
            ...
            <h1 class="h1">@<?php echo $web_user_name;?></h1>
        </div>
